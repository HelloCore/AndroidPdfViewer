        ...
        try {
            ...
            if (pdfView != null) {
                ...
                pdfFile = new PdfFile(pdfiumCore, pdfDocument, pdfView.getPageFitPolicy(), getViewSize(pdfView),
                        userPages, pdfView.isSwipeVertical(), pdfView.getSpacingPx(), pdfView.getSpacingTopPx(),
                        pdfView.getSpacingBottomPx(), pdfView.getSideMarginPx(), pdfView.isAutoSpacingEnabled(),
